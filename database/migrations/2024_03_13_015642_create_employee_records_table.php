...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employee_records', function (Blueprint $table) {
            ...
            //Employee Shifts
            $table->unsignedBigInteger('shift_id'); //employee should be connected to one shift
            ...
            $table->foreign('shift_id')->references('id')->on('shifts')->onDelete('cascade'); //creates a connection between shift table
